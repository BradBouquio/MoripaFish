...
class WorldGuardHooker : PluginHooker {
    ...
    fun containsLocation(regionId: String, location: Location): Boolean {
        ...
        val regionContainer = WorldGuard.getInstance().platform.regionContainer.get(world) ?: throw IllegalStateException("Couldn't get region container")
        val region = regionContainer.getRegion(regionId)
